<template>
    ...
    <div class="mainUserBx">
      ...
      <div class="mainUserTxtBx">
        ...
        <div class="mainUserInfos">
          <div class="mainUserProfile" @click="openPopup('aboutMe')">Profile</div>
          <div class="mainUserCareer" @click="openPopup('career')">Career</div>
  ...
  <ContactArea v-if="contact" ref="contactArea" class="contact-area"></ContactArea>
</template>
